...
const FORBIDDEN_ITEM_FIELDS = [
  ...
  // What is fitted inside a cabinet: rails, bins, lights. Staff only for now
  // (decided 13 September 2026), the same as the handle and the hinge above,
  // and every one of them is a priced catalogue item.
  "accessories",
];
