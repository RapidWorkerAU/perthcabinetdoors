...
//
// awaiting_deposit belongs here for exactly the same reason as sent and viewed:
// the customer is holding a link and a price, and here they are part way through
// paying it. The fallback below already treated it this way, since an unknown
// status is taken as sealed, but a rule this important should be written down
// rather than inherited from a default.
const SEALED_STATES = new Set(["sent", "viewed", "awaiting_deposit"]);
