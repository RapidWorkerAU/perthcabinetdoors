...
const FALLBACK_CONFIG = {
  ...
  optionSets: {
    ...
    profileTypes: ["Minimal", "Soft", "Sharp", "Detailed", "Fluted"],
    profilesByProfileType: {
      Minimal: ["Oslo", "Capri", "Milan"],
      Soft: ["Verona", "Florence", "Como"],
      Sharp: ["Atlanta", "Soho", "Brooklyn"],
      Detailed: ["Hampton", "Provence", "Tudor", "Allandale", "Branxton", "Briar", "Chiswick 12", "Chiswick 6", "Hampshire", "Keimbah", "Malabar", "Pokolbin", "Rothbury"],
      Fluted: ["Cove 25", "Cove 50", "Peak"],
    },
