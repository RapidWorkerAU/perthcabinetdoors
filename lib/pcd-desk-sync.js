...
export async function syncMailbox(supabase, { firstRunDays = FIRST_RUN_DAYS, limit = 500, since: forcedSince = null } = {}) {
  ...
  const summary = { ok: true, error: "", configured: true, scanned: messages.length, added: 0, tickets: 0, customers: 0, attachments: 0, skipped: 0, ignored: 0, awaiting: 0, alreadyHeld: 0, problems: [] };
