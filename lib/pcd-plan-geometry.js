...
import { islandVirtualWall, cabinetVerticalSpanMm, isCornerShaped } from "./pcd-kickboard-utils";
import {
  endPanelSpanMm,
  backPanelDepthMm,
...
// elevation, exactly as a base/wall/tall cabinet does. (Corner cabinets and
// floating shelves are handled separately / don't return.)
const RETURN_TYPES = new Set(["base_cabinet", "wall_cabinet", "tall_cabinet", "bookcase", "obstruction"]);
