...
export function businessDefaultsToDbRow(defaults = {}) {
  ...
  return {
    ...
    runner_unit_cost_standard_ex_gst: normalized.runner_unit_cost_standard_ex_gst,
    runner_unit_cost_soft_close_undermount_ex_gst: normalized.runner_unit_cost_soft_close_undermount_ex_gst,
    runner_unit_cost_soft_close_side_ex_gst: normalized.runner_unit_cost_soft_close_side_ex_gst,
...
const OPTIONAL_COLUMNS = [
  "variation_terms",
  "runner_unit_cost_standard_ex_gst",
  "runner_unit_cost_soft_close_undermount_ex_gst",
  "runner_unit_cost_soft_close_side_ex_gst",
];
