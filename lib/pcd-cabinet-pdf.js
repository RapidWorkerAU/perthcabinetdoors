...
function panelPlanFor(item, panelKey) {
  ...
  return {
    ...
    // per-panel note hid whatever was written on the line itself.
...
const MTO_COLUMN_SHARES = [
  ...
  { key: "ref", label: "Ref", share: 7 },
  { key: "eta", label: "ETA", share: 6 },
  { key: "status", label: "Status", share: 6 },
  { key: "notes", label: "Notes", share: 15 },
];
 ...
 */
export function generateOrderCutListPdf({ order, items, quoteLines = [], variations = [], variationLines = [], panelNumbers = null, issues = [] }) {
