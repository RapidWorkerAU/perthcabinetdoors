...
import { COLOUR_FINISHES, COLOUR_SUPPLIERS } from "./pcd-colour-library";
import { PROFILE_SUPPLIERS } from "./pcd-profile-suppliers";
import { HARDWARE_BRANDS } from "./pcd-hardware-types";
...
export const LISTS = [
  ...
  {
    key: "colour_finishes",
    label: "Board finishes",
    note: "The finish a board comes in. The spelling here is the one every screen groups and filters by.",
    where: "The finish on a colour, and the finish groups on /finishes",
    fields: [],
    builtin: asNamed(COLOUR_FINISHES),
  },
  {
  ...
  },
  {
    ...
    note: "Who makes a hinge, runner or rail. The spelling here is what the hardware library groups by.",
    where: "The brand on a hardware item",
    fields: [],
    builtin: asNamed(HARDWARE_BRANDS),
  },
  {
    key: "room_areas",
    label: "Rooms",
