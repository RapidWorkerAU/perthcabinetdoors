...
function lineMaterial(line = {}) {
  return [line.material, line.thickness].filter(Boolean).join(" / ") || "-";
}
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;">
        <thead>
          <tr style="background:#f5f3ee;">
            ...
            <th align="left" style="padding:9px 8px;color:#64748b;font-size:11px;line-height:15px;text-transform:uppercase;letter-spacing:.6px;">W x H</th>
