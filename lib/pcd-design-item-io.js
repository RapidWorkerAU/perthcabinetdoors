...
export const CABINET_TYPES = ["base_cabinet", "wall_cabinet", "tall_cabinet", "corner_base_cabinet", "corner_tall_cabinet", "blind_corner_cabinet"];
...
export const VALID_ITEM_TYPES = [...CABINET_TYPES, "floating_shelf", "door", "drawer_front", "panel", "scribe", "obstruction", "window", "door_opening", "appliance", "brick_corner_pantry"];
