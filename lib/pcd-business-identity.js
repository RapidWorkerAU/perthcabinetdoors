...
/** The same number as a dialable href, so a tel: link is not a second copy. */
export const BUSINESS_PHONE_TEL = `tel:${BUSINESS_PHONE.replace(/\s+/g, "")}`;

/** The legal entity behind the trading name, for tax documents. */
export const BUSINESS_ABN = "27617956215";

// THE SAME NUMBER, GROUPED THE WAY THE REGISTER PRINTS IT. An ABN is read back
// in twos and threes, and a run of eleven digits is read back wrong. Everything
// a customer sees uses this; the bare digits stay for anything typed into a
// field that will not take spaces.
export const BUSINESS_ABN_SPACED = "27 617 956 215";
