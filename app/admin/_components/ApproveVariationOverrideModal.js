        ...
        {allowed ? (
          <>
            <div className="rounded-[6px] border border-[#a8c5a0] bg-[#edf4eb] px-3 py-2.5 text-[13px] leading-[1.55] text-[#2d5e28]">
              The new sizes go straight onto the order and the workshop cuts to them.{" "}
              <strong className="font-semibold">The order total does not change.</strong> Each line keeps the price
              it already has, so nothing new is owed and the deposit and balance stay as they are.
            </div>

            {/* WHAT IS ABOUT TO HAPPEN, LINE BY LINE.
                Height before width, as everywhere else. The held price sits in
                its own column so it is obvious that it is the same number on
              ...
              {changes.map((change) => (
                ...
                >
                  <span className="text-[13px] leading-[1.45] text-[#1a1a18]">
                    ...
                    <br />
                    <span className="text-[#5a5a52]">{change.from}</span>
                    <span className="text-[#8b8a81]"> becomes </span>
                    <span className="font-semibold text-[#2d5e28]">{change.to}</span>
                  </span>
          ...
          <>
            ...
            <p className="m-0 text-[13px] leading-[1.55] text-[#5a5a52]">
              Send it the normal way and let them answer, or take the lines that are only size changes onto a
