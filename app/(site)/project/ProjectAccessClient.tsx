  ...
  return (
    <div className="quote-access">
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold text-slate-900">Access your project</h1>
        <p className="text-sm text-slate-600">
          Enter the access code provided by HSES to view your project schedule.
        </p>
      </div>
      <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
        ...
        <button type="submit" className="qb-btn qb-btn--dark w-full" disabled={isSubmitting}>
          {isSubmitting ? "Checking..." : "View project"}
        </button>
      </form>
    </div>
  );
