...
function thicknessOptionsForSelection(material, availability) {
  ...
  return (
    <form className={styles.quoteFormTable} onSubmit={submitQuote}>
      ...
      {editingItem ? (() => {
        ...
        const thicknessOptions = thicknessOptionsForSelection(editingItem.material, colourAvailability);
