  ...
  return (
    <form onSubmit={submitContact}>
      ...
      <div className={styles.fieldRow}>
        <div className={styles.field}><label htmlFor="firstName">First name</label><input id="firstName" name="firstName" type="text" placeholder="e.g. Sarah" /></div>
      ...
      <div className={styles.fieldRow}>
        ...
        <div className={styles.field}><label htmlFor="email">Email address</label><input id="email" name="email" type="email" placeholder="e.g. sarah@email.com" /></div>
      </div>
      ...
      <div className={styles.fieldFull}>
        <div className={styles.field}>
          ...
          <textarea id="message" name="message" placeholder="Tell us what you are thinking. Even rough ideas are helpful." required />
        </div>
      </div>
